...
- Current focus: Setting up the learning repository structure and assistant workflow
...
| --- | --- | --- | --- |
| Repository setup | In progress | `README.md`, `ai-docs/docs/setup/` | Initial MkDocs and environment setup exists. |
...
| ML basics | Planned | `ai-docs/docs/ml/basics.md` | Placeholder created for foundations. |
| AI system design | Planned | `ai-docs/docs/system-design/ai-systems.md` | Placeholder created for architecture notes. |
| Jupyter notebooks | Planned | `ai-docs/docs/notebooks/index.md` | Notebook index created; add summaries as notebooks are added. |
...
- Add a first ML basics note, such as linear regression, classification metrics, or train/test splits.
- Add a notebook naming convention and summary template before many notebooks are created.
- Decide whether to track experiments under `ai-docs/docs/projects/` only or keep raw notebooks in a separate top-level `notebooks/` directory.

## Open Questions

- What is the first concrete AI engineering topic or project to study?
...
| --- | --- | --- | --- |
| _None yet_ | Planned | Add notebook entries here as they are created. | Define notebook workflow. |
